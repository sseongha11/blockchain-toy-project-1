        ...
        <section id="welcome" className="welcome">
          <Row className="header my-3 p-3 mb-0 pb-0">
            <Col xs={12} md={12} lg={8} xxl={8}>
              <h1>NFT Project</h1>
              <p className="sub-header">Availble on 11 / 11 / 22</p>
            </Col>
            <Col className="flex social-icons">
              <a
                href="https://www.sseongha.com"
                target="_blank"
          ...
          <Row className="flex m-3">
            ...
            <Col md={5} lg={4} xl={5} xxl={4}>
              ...
              <p className="text">
                This toy project developed by Seongha aims to generate NFT
                images, upload to IPFS, create NFT contract, and use OpenSea!
              </p>
            ...
            <Col md={5} lg={4} xl={5} xxl={4}>
              {isError ? (
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      1,000 generated punked out images using an art generator
                    </li>
